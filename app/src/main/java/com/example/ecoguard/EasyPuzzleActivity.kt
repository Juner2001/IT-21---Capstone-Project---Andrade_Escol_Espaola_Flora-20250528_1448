...
class EasyPuzzleActivity : AppCompatActivity() {
        ...
        databaseRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (speciesList.isNotEmpty()) {
                    ...
                    Toast.makeText(this@EasyPuzzleActivity, "No images found in database.", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onCancelled(error: DatabaseError) {
                progressBar.visibility = View.GONE
                Toast.makeText(this@EasyPuzzleActivity, "Error loading image: ${error.message}", Toast.LENGTH_LONG).show()
            }
        })
    }
